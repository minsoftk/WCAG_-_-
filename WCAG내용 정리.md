...
- 그림과 같이 한 사이트에는 작성 내용 이해하기 어려움을 가진 사람들을 위해 도움말 링크가 있습니다. 그림에서처럼 `작성안내` 버튼을 누르면 설명이 나타납니다. 이를 통해 구직자의 이해도를 높입니다.

![NH 온라인 입사 지원](https://github.com/minsoftk/TIL/blob/master/blog/3.3.5-2.png?raw=true)
